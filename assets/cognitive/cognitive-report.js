(function(){
  ...
  var BRAIN_WEIGHTS = {
    attention:    [0.40,0.52,    0,    0,    0,    0,    0,    0,0.04,0.04],
    shortmem:     [   0,    0,0.12,0.30,0.25,0.28,    0,    0,0.03,0.02],
    memory:       [0.28,    0,    0,    0,    0,    0,0.48,0.18,0.03,0.03],
    flex:         [0.48,0.32,    0,    0,    0,    0,0.14,    0,0.03,0.03],
    language:     [0.28,    0,    0,    0,    0,    0,0.52,0.14,0.03,0.03],
    reasoning:    [0.42,0.36,0.14,    0,    0,    0,    0,    0,0.04,0.04],
    planning:     [0.50,0.30,    0,0.14,    0,    0,    0,    0,0.03,0.03],
    scenerecall:  [   0,    0,    0,    0,    0,0.34,0.28,0.32,0.03,0.03],
    memorg:       [0.32,    0,    0,    0,    0,    0,0.44,0.18,0.03,0.03],
    inhibition:   [0.32,0.52,0.10,    0,    0,    0,    0,    0,0.03,0.03],
