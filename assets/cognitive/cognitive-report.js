(function(){
  ...
  // Brain region weights: 12 modules x 10 regions
  //   [0]左额叶 [1]右额叶 [2]左顶叶 [3]右顶叶 [4]左枕叶 [5]右枕叶 [6]左颞叶 [7]右颞叶 [8]左小脑 [9]右小脑
  var BRAIN_WEIGHTS = {
    attention:    [0.40,0.30,0.10,0.10,0.02,0.02,0.05,0.05,0.03,0.03],
    shortmem:     [0.15,0.15,0.20,0.20,0.05,0.05,0.10,0.10,0.03,0.03],
    memory:       [0.20,0.15,0,0,0.02,0.02,0.30,0.25,0.05,0.05],
    flex:         [0.30,0.25,0.10,0.10,0.05,0.05,0.05,0.05,0.03,0.02],
    language:     [0.25,0.15,0,0,0,0,0.35,0.20,0.03,0.02],
    reasoning:    [0.30,0.20,0.15,0.15,0.05,0.05,0.05,0.05,0.03,0.03],
    planning:     [0.30,0.20,0.15,0.10,0,0,0.10,0.05,0.05,0.05],
    scenerecall:  [0.10,0.10,0.10,0.10,0.10,0.10,0.15,0.15,0.05,0.05],
    memorg:       [0.20,0.15,0.10,0.05,0,0,0.25,0.15,0.05,0.05],
    inhibition:   [0.35,0.25,0.10,0.05,0,0,0.10,0.05,0.05,0.05],
    visual:       [0.10,0.10,0.15,0.15,0.20,0.15,0.05,0.05,0.04,0.04],
