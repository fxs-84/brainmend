// 报告分类与搜索过滤 (纯函数模块, 由 cognitive-report.js 复用)
import {
  getReportType,
  classifyByKind,
  filterRecords
...
(function(){
  ...
  var ANALYSIS = {
      "attention": {
            "0": {
                  "study": "你的注意力控制存在明显障碍。学习时几乎无法有效屏蔽环境干扰——他人的走动、声响、手机提示都会轻易打断你的思路。考试时可能因频繁走神导致时间严重不足，后半部分来不及作答。建议从极短时间的专注练习（如5分钟番茄钟）开始训练。",
                  "work": "工作中你难以维持对单一任务的持续关注，外界干扰或次要事务会轻易将你带离正轨。频繁刷手机、反复切换任务是常见表现，深度工作时效率严重受损。建议减少工作环境中的干扰源，每次只设定一个核心目标。",
                  "social": "你在社交中缺乏持续的注意力，容易在对话中走神、冲动插话或打断对方。对方可能因感到不被认真倾听而疏远。建议练习在倾听时保持眼神接触，先听完对方完整表达再回应。"
            },
            "1": {
                  "study": "你的注意力水平处于正常偏低范围。在安静、无干扰的环境中能够保持基本专注，但一旦面对复杂度提升、时间压力或环境噪声，注意力就容易涣散。考试中可能因焦虑或疲劳而在非关键细节上耗费过多时间。",
                  "work": "在工作环境相对安静时你可以维持基本的任务关注，但多任务并行或遇到持续干扰时，效率会明显下降。建议规律性短暂休息，避免注意力疲劳累积影响整体产出。",
                  "social": "你能维持基本的社交交流注意，但对话时间较长或话题不感兴趣时容易走神，偶尔会错过对方表达中的微妙信息。在重要对话中可以有意识地做简短总结，帮助自己保持专注。"
            },
            "2": {
                  "study": "你的注意力基本能够满足日常学习需求。在常规环境中能够过滤大部分无关干扰，将精力聚焦在关键内容上。面对一般复杂度的学习任务，能够维持完成任务所需的专注时长。",
                  "work": "你基本能够应对常见工作场景中的注意力需求：合理分配关注点、区分轻重缓急。在大多数情况下不会因注意力涣散而影响工作产出质量。",
                  "social": "你在社交中基本能够保持对对话对象的关注，倾听与回应的节奏较为自然。在多人交谈中能够抓住主要信息点，不至于遗漏关键内容。"
            },
            "3": {
                  "study": "你的注意力表现良好，超出多数同龄人。无论在安静还是有一定干扰的环境中，都能迅速锁定目标并维持高质量专注。面对大量学习材料，善于提炼框架和要点而非被细节淹没。",
                  "work": "在多任务并存的工作场景中，你能有效分配并切换注意力，优先处理重要紧急事项。你的专注状态对周围同事有正向带动作用。",
                  "social": "你的社交注意力分配合理且敏锐——不仅专注倾听，还能同步捕捉对方的微表情、语气变化和肢体语言，洞察比字面更多的信息。这让你的社交互动深入且高效。"
            },
            "4": {
                  "study": "你的注意力堪称卓越。无论环境如何变化——嘈杂、高压、多线程——你都能瞬间进入深度专注状态并长时间保持。面对海量学习材料，你本能地识别核心框架，过滤掉一切冗余信息。这是顶尖学习者的核心素质。",
                  "work": "在极端高压、多线程并行的环境中，你依然保持极高的工作专注度。不仅自己对焦精准，你对团队整体的注意力分配也有敏锐的感知，能在关键时刻提醒聚焦方向。",
                  "social": "你的社交注意力是一流的——不仅仅是在听，更是在全方位感知对方的状态。你能在多人复杂对话中精准捕捉每个人的立场、情绪变化和潜在意图。这使得你在任何社交场合都从容不迫。"
            }
      },
      "shortmem": {
            "0": {
                  "study": "你的短暂视觉记忆功能存在明显障碍。课堂上的板书、PPT、演示画面看完后难以在脑海中保留片刻，转身即忘。这意味着你需要反复查看同样的信息才能勉强消化，学习效率受到严重影响。",
                  "work": "面对即刻呈现又瞬间消失的视觉信息——如屏幕弹窗、仪表读数变化、数据刷新——你基本无法可靠地记住。这在快节奏、信息密集型工作场景中构成明显的效率瓶颈。",
                  "social": "在社交中，你难以记住刚刚发生的视觉信息——对方的长相特征、表情变化、穿着细节——转眼就模糊。虽然不妨碍基本交流，但这会削弱你建立亲密关系的能力，因为对方期待被记住的细节你没有捕捉到。"
            },
            "1": {
                  "study": "你的短暂视觉记忆处于正常偏低水平。对新呈现的视觉信息，你能记住大致轮廓和主体内容，但细节——如图表的具体数值、标注的位置——容易丢失。需要在观看后有意识地强化才能完整保留。",
                  "work": "在需要快速整合视觉信息的工作场景中——同时对比多个屏幕、整理多份资料——你偶尔会感到吃力。建议养成即时笔记的习惯，把关键视觉信息及时转化为文字来辅助记忆。",
                  "social": "你大约能回忆起社交场合中对方的整体形象和基本互动，但微妙的视觉细节——对方说话时的眼神变化、手势的细微转换——印象较为模糊。这是可以通过有意识观察来提高的。"
            },
            "2": {
                  "study": "你的短暂视觉记忆基本能够满足日常学习需要。对即刻呈现的视觉信息，你能够较为完整地保留数分钟，并在需要时提取关键内容。在观看教学视频或现场演示时，不至于遗漏关键步骤。",
                  "work": "你基本能够在本就多变的视觉信息流中保持有效的即时记忆——记住仪表盘读数趋势、整理刚刚浏览的多份文档要点。日常信息密集型工作不至于因短暂记忆不足而出错。",
                  "social": "你基本能够记住社交互动中刚刚发生的视觉关键信息——对方的表情变化、手势、以及周围环境的显著变化。这让你在后续交流中能够引用这些细节，维持基本的互动质量。"
            },
            "3": {
                  "study": "你的短暂视觉记忆表现良好。你就像拥有一个高效的视觉缓存，眼前闪过的画面能被你短暂而精准地保留。这种能力让你在学习新技能时看一遍就能掌握动作要领，效率优于多数同龄人。",
                  "work": "你善于同时追踪多路视觉信息——实时数据流、多个显示器内容——切换之间游刃有余。这种即时记忆的容量和精度，是高效职场人士的重要能力筹码。",
                  "social": "在社交场合中，你能够精准捕捉并短暂记住对方的微表情、手势和肢体动作。这让你对当下的社交氛围有敏锐的感知力，总能做出恰当的回应。"
            },
            "4": {
                  "study": "你的短暂视觉记忆极为出色。任何视觉信息在你眼前闪过一次，就能被精准、高保真地短暂留存。这种视觉缓存的超大容量和精度，让你在快节奏学习环境中始终保持信息不丢失的高效状态。",
                  "work": "在工作中，你是多路视觉信息流中的定海神针——无论多少实时变化的视觉数据同时涌入，你都能精准追踪、有序处理，从不遗漏。",
                  "social": "社交场合中，你的视觉记忆敏锐度令人印象深刻——每一帧微表情、每一个动作细节都被精确捕捉并留存。这让你对他人的状态理解远超常人，总能在最恰当的时机给出最恰当的回应。"
            }
      },
      "memory": {
            "0": {
                  "study": "你的文字记忆能力明显低于平均水平。学习时需要反复阅读同一段文字多次才能留下印象，需要背诵的科目尤其吃力。你可能不得不依赖图表、视频等辅助方式来弥补文字记忆的不足，但这只能部分补偿。",
                  "work": "在工作中你严重依赖笔记、待办清单和手机提醒。离开这些外部工具，你很容易忘记任务内容、截止日期和关键数据——这不是好习惯的体现，而是文字记忆缺陷的补偿策略。这会增加出错和延误的风险。",
                  "social": "你在社交中容易忘记刚认识的人的名字、之前聊过的内容和约定。对方可能因此感到不被重视。建议在初次见面后有意识地重复对方的名字和关键信息来强化记忆。"
            },
            "1": {
                  "study": "你的文字记忆能力处于正常偏低水平。对中等篇幅的文字材料，你比同龄人多花一些时间反复阅读才能掌握。考试复习需要更早开始，但只要投入足够时间，仍能取得可接受的成绩。",
                  "work": "处理工作中的书面信息时，你偶尔需要回头确认细节——邮件中的数据、会议纪要中的关键决议。虽然不至于遗漏重要信息，但反复确认会拖慢工作节奏。",
                  "social": "在社交中，你能记住对方大致说了什么，但具体的人名、日期、地点偶尔需要对方再提醒一次。你可以在对话中有意复述关键点，这既能确认理解也能辅助记忆。"
            },
            "2": {
                  "study": "你的文字记忆基本能够满足日常学习需求。对于课堂上听讲的内容和课后的阅读材料，你能有效吸收并在合理时间内保持准确回忆。考试前不需要过度刷题也能回忆起大部分核心知识点。",
                  "work": "你基本能够记住工作中的邮件内容、会议要点和任务要求，不需要频繁回头确认。这保证了你的工作节奏相对流畅，同事对你的信息准确性有基本信赖。",
                  "social": "你基本能够记住社交中的重要信息——对方的名字、职业、上次聊天的大致内容。再次见面时能自然地提及这些，让对方感到基本的尊重和重视。"
            },
            "3": {
                  "study": "你的文字记忆能力良好。听过一遍的讲座、看过一遍的文件，你能在大脑中形成清晰的记录并在较长时间内保持。这种能力让你在学业中占据优势——不需要死记硬背就能自然积累大量知识。",
                  "work": "在工作中，你是团队里信息检索效率最高的人之一。别人还在翻邮件找数据时，你已经准确回忆出了关键数字和决议。这种可靠性让你在同事眼中格外值得信赖。",
                  "social": "你的记忆力让社交互动更加深入——见过一次的人你能叫出名字，几个月前聊过的内容你能精准引用。这种能力是建立深厚人际关系的天然优势。"
            },
            "4": {
                  "study": "你的文字记忆能力极为突出。你拥有接近过目不忘的信息吸收和保持能力。任何文字材料深入阅读一遍，就能在大脑中形成长期、高保真的记忆。这让你在任何需要大量知识储备的学科中都如鱼得水。",
                  "work": "你是团队中不可替代的活档案和信息中枢。去年的会议决议、项目的原始背景、关键数据的历史变化——你随口就能精准提供。这种记忆底蕴是你最核心的职业竞争力。",
                  "social": "你的社交记忆力令人惊叹。初次见面的人你第二次就能叫出名字和背景，多年前的对话你能信手拈来。这种被记住的体验让每个与你交往的人都感到自己是被珍视的。"
            }
      },
      "flex": {
            "0": {
                  "study": "你的思维变通能力存在明显障碍。面对新的学习方法或思路，你倾向于固守熟悉但不一定高效的方式。用死记硬背应对需要理解应用的课程，最终事倍功半。切换到新题型或新解题思路时适应期很长。",
                  "work": "你在工作中偏好严格按固定流程操作，一旦遇到计划外的状况就容易卡住。不是缺乏解决问题的能力，而是大脑的思维惯性太强，切换思路需要较长时间。这在需要灵活应变的工作环境中是明显短板。",
                  "social": "你在社交中显得较为固执，难以接纳与自己不同的观点。当对话出现分歧时，倾向于坚持原有立场而不是尝试理解对方的视角。长期下来可能让身边的人逐渐减少与你深入交流的意愿。"
            },
            "1": {
                  "study": "你的思维灵活性处于正常偏低水平。你已经适应了某些固定的学习方式，当教学方法突然改变或题目形式变化时，需要一段适应期才能跟上。日常可以刻意练习用不同方法解同一道题来锻炼思维的弹性和容错能力。",
                  "work": "面对工作中的突发状况或需求变更，你会先感到一阵不适和抗拒，需要一定时间才能调整过来。虽然最终能适应，但这个切换成本在快节奏环境中会让你略显吃力。",
                  "social": "在社交互动中，当场面突然转向你不熟悉的领域或出现尴尬状况，你可能不太能灵活应对，会不由自主回到自己擅长的安全话题。慢慢学会接纳不确定和意外，对提升社交变通力很有帮助。"
            },
            "2": {
                  "study": "你的思维变通能力基本能够应对日常学习场景。面对常规的变化——换一种教学方法、换一套题目风格——你能够在一段时间后调整过来。遇到困难时，能够接受并尝试不同的解题思路，不至于固守无效方法。",
                  "work": "你基本能够适应工作中的常规变化——需求调整、流程优化、工具更换。虽然可能需要一个短暂的适应期，但最终能够跟上变化节奏，不至于成为团队的瓶颈。",
                  "social": "在社交场合中，你基本能够根据不同的对象和氛围调整自己的交流方式。在正式和非正式场合之间的切换不至于生硬，能够维持基本的社交舒适度。"
            },
            "3": {
                  "study": "你的思维变通能力良好。你能根据不同的学习内容和场景，灵活切换学习策略。知道什么时候该精读、什么时候该略读、什么时候该换一种理解角度。这种弹性使你的学习效率超出多数同龄人。",
                  "work": "面对工作中的变化和挑战——方案被推翻、需求临时变更——你不会慌乱，总能快速找到替代方案。这种此路不通换条路的弹性是你职场适应力的核心保障。",
                  "social": "社交场合中，你能根据不同的对象和氛围自然调整表达和互动方式。在正式商务场合和轻松朋友聚会间切换自如，让人觉得和你相处舒适自然。"
            },
            "4": {
                  "study": "你的思维变通能力极为出众。你天生就是多解法思维者——面对任何问题，你本能地生成多种解决方案并灵活选择最优路径。新领域对你来说不存在适应期，因为你早已内化了如何学习的元能力。",
                  "work": "你是团队中不可替代的创新引擎。当常规方案全部行不通时，你是那个总能跳出框架、从完全不同的角度找到解法的人。在高度不确定的环境中，你的灵活思维是团队最宝贵的资产。",
                  "social": "你的社交变通能力堪称一流。无论面对什么类型的人——强势的、敏感的、沉默的、热情洋溢的——你都能精准调整互动方式。你不是在扮演不同角色，而是真的能灵活切换视角去理解不同的人。"
            }
      },
      "language": {
            "0": {
                  "study": "你在理解复杂文字材料方面存在明显障碍。阅读长篇段落时容易迷失在字里行间，难以准确抓住作者的核心意图。做题时可能因误解题干而答非所问，即使知识本身你是掌握的。",
                  "work": "工作中面对书面指令、政策文件或技术文档时，你可能感到力不从心。一些表述不明确的内容会让你反复揣摩却仍不确定，而同事可能一眼就理解。这既拖慢工作进度，也可能因理解偏差导致执行错误。",
                  "social": "在需要精确理解对方言语的社交场合——如谈判、重要讨论——你可能无法准确判断对方的真实意图和言外之意。你听到的是表面字句而非弦外之音，这让你在复杂社交博弈中处于弱势。"
            },
            "1": {
                  "study": "你的语言理解能力处于正常偏低水平。面对普通阅读材料你可以基本理解，但遇到带条件性的复杂语句或含多层逻辑的段落时，理解速度会明显下降。建议在阅读时尝试用自己的话复述每个段落来确认理解是否到位。",
                  "work": "处理日常工作指令和邮件你没有太大困难，但遇到表述不够清晰或有多重解读空间的内容时，你偶尔会误解其中某些细节。在重要任务上建议口头向对方确认你的理解是否正确。",
                  "social": "你能理解日常对话和直白的社交表达，但当对方使用讽刺、双关或含蓄委婉的表达时，你可能揣摩半天或完全错过。多注意对方说话时的语气和语境，能帮助你更好地听懂话外之音。"
            },
            "2": {
                  "study": "你的语言理解能力基本能够满足日常学习和阅读需求。对于常规的课堂讲授和阅读材料，你能够理解核心意思，不至于因为理解偏差而答错基础题。在阅读后能够提炼出主要信息点。",
                  "work": "你基本能够理解各种书面指令和日常文档，对于带有一定专业术语和常规复杂度的材料，你能够读懂主要内容并执行。你的书面和口头表达也基本清晰，接收方不容易产生误解。",
                  "social": "在社交互动中，你基本能够理解直接的表达和常见的社交暗示。日常交流中不会因为语言理解偏差而产生明显的人际摩擦。"
            },
            "3": {
                  "study": "你的语言理解能力良好。无论是课堂上的口头讲授还是课后的阅读材料，你都能精准理解核心意思，不会出现因误解而答错的情况。你还善于从阅读材料中提炼关键信息，形成自己的理解框架。",
                  "work": "你能准确理解各种书面指令和文档，包括带有行业术语和复杂表述的专业材料。你的表达同样清晰有条理，让接收方不容易产生误解。",
                  "social": "在社交互动中，你不仅能理解直白的表达，也听得懂含蓄的暗示和委婉的拒绝。这种听得懂的能力让你的人际关系处理更加圆融。"
            },
            "4": {
                  "study": "你的语言理解能力极为出色。你不只是在阅读文字，而是在精准解码作者的意图、立场和潜在假设。面对晦涩的专业论文、复杂的法律条文或文学作品，你也能快速穿透表面语言找到核心逻辑和深层含义。",
                  "work": "在工作中，你是团队解读复杂文档和政策的权威。别人还在纠结某段表述到底什么意思时，你已经提炼出了关键要点和行动方案。这种能力让你在任何信息密集型岗位上都不可或缺。",
                  "social": "你的社交语言理解力极其敏锐。你听得懂对方话里的情绪底色、潜在立场和未明说的诉求。常常在对方还没组织好语言之前就已经理解了他们的困惑。这让你的社交深度远超常人。"
            }
      },
      "reasoning": {
            "0": {
                  "study": "你的逻辑推理能力存在明显薄弱环节。在面对需要多步推导的问题时，容易在中途迷失方向，或者只捕捉到表面信息而无法深入挖掘背后的规律。数学、理化等需要严密逻辑的学科会让你感到特别吃力。",
                  "work": "在工作中，面对需要系统性分析和推理的复杂问题时，你可能难以构建清晰的解决路径。遇到突发状况时，容易凭直觉和情绪做出反应而非经过理性推敲，这可能导致决策明显偏离最优解。",
                  "social": "在需要理性判断的社交情境中，你可能容易被情绪或表面信息误导，做出不够合理的判断。比如轻信他人表面言辞而忽略了行为逻辑中的明显矛盾。"
            },
            "1": {
                  "study": "你的推理能力处于正常偏低水平。简单直接的推理你能够完成，但遇到需要多步骤层层推导的复杂问题，解题速度和准确度都会下降，偶尔也会走入弯路。建议多练习追问为什么——每次得出答案后再问自己然后呢。",
                  "work": "你能应对日常工作中基本的逻辑判断场景，但遇到需要系统性分析的问题时，推理过程可能会有些磕绊。可以通过画思维导图或列出推理步骤来帮助自己梳理思路、避免跳跃。",
                  "social": "在社交中你能做出基本合理的判断，但遇到复杂的人际矛盾——比如判断谁在隐瞒、谁在挑拨——分析起来可能不够精准。学会把行为和动机分开分析，对提升社交推理有帮助。"
            },
            "2": {
                  "study": "你的逻辑推理能力基本能够应对日常学习中的推理需求。面对常规的逻辑题和多步骤问题，你能够按照基本逻辑链条推导出结论。虽然速度和深度可能不突出，但不会因推理能力不足而严重影响学业表现。",
                  "work": "你基本能够对工作中的常规问题进行有条理的分析，能够识别问题的直接原因并提出基本可行的解决方案。在日常工作场景中不至于因推理能力不足而频繁出错。",
                  "social": "在社交中，你基本能够根据对方的行为和言语做出合理判断。不会轻易被表面说辞完全蒙蔽，能够识别比较明显的言行矛盾。"
            },
            "3": {
                  "study": "你的逻辑推理能力良好。你可能不觉得自己在刻意推理，因为这种能力已经内化成了日常思维的一部分。你善于从分散的信息中发现规律和关联，分析问题时习惯追问根本原因而不是停留在表面。",
                  "work": "你能够系统性地分析工作中的复杂问题，从多个角度构建推理框架。你的分析深度让你提出的解决方案比同事更有说服力，也更能经得起推敲。",
                  "social": "在社交中，你善于透过现象看本质。你不会轻易被华丽的言辞打动，而是会综合对方的言行来评估其真实意图。这种理性和敏锐的结合让你不容易在复杂人际关系中吃亏。"
            },
            "4": {
                  "study": "你的推理能力堪称卓越。你天生善于发现隐藏的模式和规律，能从别人注意不到的细微线索中推导出完整图景。任何需要严密逻辑和深度思考的学科对你来说都是舒适区。",
                  "work": "在你的团队中，你是那个总能提出全新分析角度的人。你擅长在迷雾中找到方向、在高度复杂的问题中搭建清晰的分析框架。这种核心能力是高级决策层的基础素质。",
                  "social": "你对人际关系的洞察力极强。你能从一个人的行为模式、言语逻辑和情绪变化中精准判断他的性格结构、真实动机和可能的下一步行动。这不是读心术，而是高度发达的社交推理能力。"
            }
      },
      "planning": {
            "0": {
                  "study": "你的规划能力存在明显不足。你可能经常到了考试前几天才发现要复习的内容堆积如山，之前完全没有合理分配时间。不是因为不够努力，而是缺乏目标—时间—步骤的基本规划意识和习惯。",
                  "work": "在工作中，你不擅长在多个任务之间按照轻重缓急进行排序。典型表现是哪个催得急就做哪个，导致真正重要但不紧急的事情不断被延期。这种被动救火的工作方式让你长期处于高压和疲惫状态。",
                  "social": "你的社交安排较为随性，很少主动规划与重要关系人的互动时间。朋友们可能会觉得你总是很忙或者约不到你，而实际上你可能只是缺乏提前规划的习惯。"
            },
            "1": {
                  "study": "你的规划能力处于正常偏低水平。你能够制定学习计划，但执行到一半容易偏离或放弃。可能是计划定得过于理想化，或者遇到一点阻力就选择了妥协。建议从本周只完成三项任务开始训练规划的执行力。",
                  "work": "你在工作中能列出基本的待办清单，但经常高估自己的完成能力，造成任务延迟。你可以尝试把大任务拆成更小的可执行步骤，每完成一步给自己一个确认，逐步积累执行信心。",
                  "social": "你希望维系好人际关系，但实际行动上常常是想到了才去联系。试着把重要的社交联络纳入日程规划，哪怕只是定期发条消息，也能让关系保持基本温度。"
            },
            "2": {
                  "study": "你的规划能力基本能够满足日常学习的组织需求。你会为考试和作业设定大致的时间安排，在大多数情况下能够按照计划完成主要任务。虽然计划可能不够精细，但不至于出现严重的时间管理失控。",
                  "work": "你基本能够根据任务的紧急程度和重要性来安排日常工作优先级。今天该做什么、这周的核心目标是什么——这些在你的头脑中有一个大致的轮廓，不至于完全被动应对。",
                  "social": "你基本能够有意识地维持重要的人际关系，知道哪些人需要定期联络。虽然不是每次都能完美执行，但你的人际网络不至于因长期疏于维护而萎缩。"
            },
            "3": {
                  "study": "你的规划能力良好。你会为自己的学习设定清晰的目标和时间表，并且能够合理评估自己的能力和时间，制定出切实可行、留有余地的计划。这是高效学习者的基本功。",
                  "work": "你在工作中善于根据任务权重和紧急度来精确安排优先级。当天的任务清单、本周的核心里程碑、本月的大目标——这些在你的大脑里是一张清晰的地图，同事跟着你的节奏也会感到踏实。",
                  "social": "你有意识地规划社交活动，清楚哪些关系需要花时间深度维护、哪些可以保持适度距离。你不会等到关系出问题才去修补，而是有节奏地保持互动。"
            },
            "4": {
                  "study": "你的规划能力极为出色。你不仅仅在学业上有精细的计划，更有清晰的长期个人发展蓝图。你清楚每个阶段的目标、所需资源、时间节点和潜在风险，并且能根据外部变化灵活调整而不失方向。",
                  "work": "你的规划能力是团队的核心资产。你善于在项目启动前就把完整的路线图勾勒出来，预判关键风险点和里程碑，并且为各种意外留出缓冲。团队在你的规划指引下行动有序、效率极高。",
                  "social": "在人际关系方面，你有清晰的定位和长期的维护策略。你精心经营核心关系、维持关键人脉、保护自己的社交边界。你的社交布局是有战略性的，而不是临时抱佛脚。"
            }
      },
      "scenerecall": {
            "0": {
                  "study": "你的场景回忆能力显著低于平均水平。你对于课堂上的整个学习情境——老师当时怎么讲的、同学问了什么、黑板上的布局——记忆非常模糊。你很难通过回忆上课场景来激活相关知识的记忆，这切断了你的一项重要复习线索。",
                  "work": "在工作中，你可能难以回忆起过往会议的具体情景：谁坐在哪里、当时讨论的氛围、谁提出了什么观点。在需要还原工作场景细节时，你严重依赖他人或笔记，增加了信息获取的时间和沟通成本。",
                  "social": "在维护人际关系方面，你很难自然地聊起\"你还记得上次我们一起…\"这种话题，因为你大脑里的场景记录不够清晰。这会无形中削弱你与他人建立深层连结的能力。"
            },
            "1": {
                  "study": "你的场景回忆能力处于正常偏低水平。对印象深刻的事件你能回忆起大致轮廓，但当别人追问细节——具体谁说了哪句话、当时的环境氛围如何——你的回答会比较含糊，缺乏精确的场景锚点。",
                  "work": "你能够回忆工作中重要会议或事件的基础框架，但场景中的具体细节——参与者的反应、讨论的转折点——印象不够清晰。你可能需要翻看会议记录或邮件来补充缺失的场景信息。",
                  "social": "与朋友交流时，你能回想起共同经历的主要情节，但对方提到某些有趣的具体细节时你可能没什么印象。这无伤大雅，但会错过加深情感联结的契机。"
            },
            "2": {
                  "study": "你的场景回忆能力基本能够满足日常需要。对于重要的学习场景和事件，你能够回忆起主要的脉络和核心细节。在需要的时候，能够通过回忆上课或学习时的情景来辅助提取相关知识。",
                  "work": "你基本能够回忆起过往重要会议和工作的场景框架——主要讨论内容、关键决策的背景。虽然细节精度不如笔记记录，但在日常工作中够用，不至于频繁出现完全想不起来的尴尬。",
                  "social": "在社交互动中，你基本能够参与\"记得上次…\"这类共同回忆话题，能够回忆起与朋友共处的主要情景。这让你能够维持基本的社交情感连接。"
            },
            "3": {
                  "study": "你的场景回忆能力良好。你能够较为清晰完整地回忆起过去学习和生活中的重要场景——不只是记住了信息本身，更是把当时发生了什么作为一幅完整的画面存储了下来，随时可以调取。",
                  "work": "你能准确回忆过往会议的场景信息：谁提了什么建议、大家的反应如何、最后怎么决定的。这是一项被低估的职场能力——你不需要频繁翻记录就能在关键讨论中提供有历史依据的信息。",
                  "social": "你有很好的共同记忆存储能力。和老朋友聊天时总能接上\"记得那次我们…\"的话题，并补充有趣的细节。这种能力让朋友们觉得和你的关系是有厚度、有温度的。"
            },
            "4": {
                  "study": "你的场景记忆堪称电影回放。你能清晰回忆过去场景中的每一个角色、每一句对话、每一个环境细节。这种能力让你在学习时能通过回忆上课场景就提取出大量相关信息，复习效率远超旁人。",
                  "work": "你是团队中天然的场景档案馆。半年前的会议谁说了什么、当时为什么做这个决策而不是另一个、项目的背景脉络——你精准地保留着所有场景细节。你的存在让团队始终有据可查。",
                  "social": "你的朋友们常常惊叹于你对共同经历的记忆精确度——你连这个都记得！你善于用共享记忆来经营关系，让每一次互动都建立在有厚度的情感基础之上。"
            }
      },
      "memorg": {
            "0": {
                  "study": "你对信息的组织和提取能力存在明显障碍。学习时你可能记了不少知识点，但它们在大脑里是散乱的、缺乏关联的。考试时你往往不是不会做，而是想不起来——信息就在那里但无法有效提取。",
                  "work": "工作中面对大量需要归类和提取的信息，你可能缺乏有效的组织策略。常常出现我明明在哪看过却怎么也找不到的情况，信息提取速度和准确性都低于工作要求，拖慢整体处理效率。",
                  "social": "在社交中，你有时会记混不同人告诉你的信息——把A的经历错记成B的，或者无法迅速回想起之前与某人约定的具体细节。这会让人感觉你不够用心或不够可靠。"
            },
            "1": {
                  "study": "你的记忆组织能力处于正常偏低水平。你能在大脑里对信息做基本的分类存储，但当信息量增大时，归类的准确性下降，提取速度也会变慢。建议试试思维导图或分类笔记来辅助信息的结构化存储。",
                  "work": "你能完成日常工作中大部分信息整理任务，但面对大量文件、数据和来自多个渠道的信息时，组织效率会明显下降。可以考虑用标签、文件夹、备忘录等外部工具来弥补大脑的分类短板。",
                  "social": "在社交关系中你能记住大部分重要信息，但偶尔会出现张冠李戴的尴尬。你可以尝试在通讯录中给联系人标注特征或共同话题，帮助大脑更高效地组织和管理社交信息。"
            },
            "2": {
                  "study": "你的记忆组织能力基本能够满足日常信息处理需求。你能够将不同的信息按照基本的类别和关联进行存储，在需要时能够以可接受的速度提取出来。日常学习或工作中不至于因信息组织混乱而严重受阻。",
                  "work": "你对工作信息的整理有一套基本的方法——可能是有规律的文件夹系统、简要的分类标签。在日常工作场景中，你很少出现因找不到信息而严重影响进度的情况。",
                  "social": "你基本能够记住不同社交关系中的关键信息，并且较少出现严重混淆。你知道每个人分别大概对什么感兴趣、记得他们说过的重要事情。"
            },
            "3": {
                  "study": "你的记忆组织能力良好。你善于将不同的信息按照其内在关联进行精细分类和标签化存储，需要时能够高效提取。这种能力让你的学习和工作效率都明显优于同龄人。",
                  "work": "你对工作信息的整理有一套成熟高效的方法——无论是有条理的文件夹系统、精确的标签分类还是大脑中的思维框架——你很少出现信息提取失败或混乱的情况。",
                  "social": "你能够清晰记住不同社交关系中的关键信息，并且绝不混淆。你知道每个人分别对什么话题感兴趣、还记得他们跟你说过的各种大小事情。这让你的社交互动总是有的放矢。"
            },
            "4": {
                  "study": "你的记忆组织能力极为出色。你的大脑就像一个高效的信息管理系统，自动对新信息进行精准分类、多维索引和深度关联。你不需要刻意去记，因为任何新知识都自然地融入你已有的知识网络。",
                  "work": "你是团队的知识中枢和信息架构师。面对海量、零散、多维的信息输入，你总能迅速理清脉络、建立清晰框架，并且需要时瞬间精准调取。你的信息管理能力拉高了整个团队的协作效率。",
                  "social": "你在社交中展现了高超的信息整合能力——从多个人零散的说法中拼出完整的人际关系图景，清楚谁和谁是什么关系、各自的立场和动机。这种全局洞察力让你在复杂社交网络中游刃有余。"
            }
      },
      "inhibition": {
            "0": {
                  "study": "你的自制力存在明显欠缺。学习时你几乎无法抵抗手机、游戏或其他娱乐诱惑的干扰，一旦分心就难以自我拉回。你知道应该专注，但刹车总是踩不下去。这导致你的有效学习时间被大幅压缩。",
                  "work": "在工作中你表现出明显的冲动倾向。想到什么就要立刻去做，很少先冷静分析再做决策。遇到让人恼火的情况时，第一反应往往是直接发泄情绪，而非先深呼吸再理性回应。",
                  "social": "社交场合中你的冲动控制力不足。情绪上来时管不住嘴——气头上的话、不经思考的评价——往往事后才后悔。这种冲动的言行会让人感到和你相处需要小心翼翼。"
            },
            "1": {
                  "study": "你的自制力处于正常偏低水平。多数时候你能管住自己，但在压力大或诱惑特别大时，自我控制的刹车会失灵。比如学累了就报复性刷手机、明明知道不该吃却停不下来。",
                  "work": "在工作中你能基本保持克制，但面对让你特别烦躁的人或事时，偶尔还是会冲动做出不恰当的反应。你事后会意识到自己不该那样，但当时就是没能控制住。",
                  "social": "社交中你能维持基本的礼貌和风度，但在某些特别触发你情绪的话题或情境下，可能控制不住自己的反应。练习在回应前默数三秒，会对你非常有帮助。"
            },
            "2": {
                  "study": "你的自制力基本能够满足日常自我管理需求。在大多数常规情境下，你能够对自己说不——控制刷手机的冲动、在适当的时候停止娱乐去完成必要任务。你的自控力不至于导致明显的学业或社交问题。",
                  "work": "你在工作中基本能够控制情绪化的冲动反应。面对压力和批评时，虽然内心可能不舒服，但你能够维持表面的专业和冷静，不至于做出让自己后悔的冲动言行。",
                  "social": "在社交场合，你基本能够管理自己的言行——知道什么话该说、什么不该说，什么时候需要忍耐。你的分寸感维持在正常社交的基本要求水平。"
            },
            "3": {
                  "study": "你的自制力良好。你能够在需要的时候果断对自己说不，不管是抵抗诱惑、控制情绪还是推迟满足。这种自控力为你的学业和事业发展打下了坚实基础。",
                  "work": "你在工作中展现了良好的情绪和冲动管理能力。面对压力、挑衅或诱惑时，你不会轻易被情绪绑架，而是能够冷静下来再决策。这种稳重让你赢得同事和上级的深度信任。",
                  "social": "在社交场合，你能得体地管理自己的言行。精确的知道什么话该对什么人说、什么时候该忍、什么时候该果断表态。这种分寸感让你的人际关系质量远高于冲动控制不足的人。"
            },
            "4": {
                  "study": "你的自制力堪称卓越。诱惑对你似乎不太构成诱惑——不是你没有欲望，而是你的前额叶调控系统极其强大，让你总能做出经得起推敲的理性选择。这种自控力是所有领域顶尖成就者的共同底层特质。",
                  "work": "工作中你是那个风暴中的灯塔——无论压力多大、局面多复杂、情绪张力多强，你始终保持冷静和高度理性。你的每一步决策都经过深思熟虑而不是冲动驱动。同事会说有你在就安心。",
                  "social": "你的社交自制力令人肃然起敬。即使在最激烈的争论和最具攻击性的言辞中，你也能完全控制自己的情绪和回应。你不说伤人的话、不做冲动的行为。这种自持和沉稳让你在任何社交圈中都备受敬重。"
            }
      },
      "visual": {
            "0": {
                  "study": "你的视觉记忆提取能力存在明显障碍。给你看一张复杂的图表或地图，你很难在之后准确回忆起其中的空间布局和关键方位。在需要空间记忆的学科——如地理、生物解剖、工程制图——你会感到特别吃力。",
                  "work": "工作中，对于办公环境、文件存储位置、屏幕界面布局等需要空间记忆的信息，你的记忆准确性不高。经常需要实际走到某处或重新打开文件才能确认某个东西的具体位置，增加了大量无谓的时间消耗。",
                  "social": "在社交中，你可能很难通过回忆特定场所的空间布局来触发对应的记忆。朋友提起上次在哪个餐厅哪个位置，你可能完全没有空间印象，只能尴尬地附和。"
            },
            "1": {
                  "study": "你的视觉记忆提取处于正常偏低水平。你能记住视觉场景的主要框架，但提取具体空间位置的细节时效率不高。比如知道那个图标大概在网页的某个位置，但要精确定位需要花时间浏览查找。",
                  "work": "你的空间记忆在日常工作场景中基本够用，但遇到需要精确回忆视觉布局的情况——如复现某个界面的设计、记住某个物品在仓库的准确位置——你可能需要实物参考才能确认。",
                  "social": "你对去过的地方、见过的人的外貌特征能保留大致印象，但当别人指望你准确回忆具体空间位置时，你的回答可能不够精确。这不是什么严重问题，只是偶尔会让人略感失望。"
            },
            "2": {
                  "study": "你的视觉记忆提取能力基本能够满足日常需求。对于经常接触的视觉信息——常用文件的位置、熟悉场所的布局——你能够较为准确地回忆和定位。在日常学习和工作中不至于因空间记忆不足而频繁浪费时间寻找物品。",
                  "work": "你基本能够记住工作中常用的空间信息：文档的大致存放位置、常用软件的功能布局、会议室的方位。这些基本的空间记忆能力让你日常工作流程不至于因反复查找而中断。",
                  "social": "你基本能够记住去过的地方和见过的人的外貌特征，在社交中不至于因完全认不出人或找不到地方而尴尬。日常社交场景的空间记忆需求你能够应对。"
            },
            "3": {
                  "study": "你的视觉记忆提取能力良好。你能够在需要时准确回忆之前看过的视觉场景中人和物的位置信息。学习解剖图、地理地图或其他需要空间定位的内容时，你的表现优于多数同龄人。",
                  "work": "你有良好的空间记忆库——记得文档放在哪个文件夹的哪个位置、上次会议的座位布局、某个APP功能在菜单的哪一级。这些看似不起眼的记忆，日积月累为你节省了大量寻找时间。",
                  "social": "你能准确记住社交场合中的人物位置关系和场景布局。朋友可能不经意提到上次在XX地方你坐在谁旁边，而你能清晰回忆起来。这种能力让你的社交记忆显得格外精准可靠。"
            },
            "4": {
                  "study": "你的视觉记忆提取能力极为出色。你对空间和视觉信息有着近似过目不忘的能力。任何需要空间定位的学科对你来说都是优势领域——你看一遍地图就能大致画出，看一遍解剖图就能默写关键结构。",
                  "work": "在工作中，你的空间记忆是核心竞争力之一。别人还在翻文件夹时你已经在脑海中定位到了目标信息。你对界面设计、空间布局、信息架构的敏感性远超同事，是团队中不可或缺的空间信息节点。",
                  "social": "你有着摄影式的社交记忆——去过一次的地方永远不会走错、见过一面的人永远记得对方长什么样、坐在哪里。这种能力让你在任何社交场合都显得从容、靠谱、让人安心。"
            }
      },
      "observation": {
            "0": {
                  "study": "你的观察能力存在明显薄弱。学习时你容易只见森林不见树木，忽略了题目中的陷阱词、图表中的细微差异等关键细节。考试中因粗心丢分的情况较为频繁——你可能不是不会做，而是根本没看仔细题干。",
                  "work": "对工作中的关键细节你可能不够敏感。一份合同里的细微条款差异、一封邮件中的语气暗示——容易被你忽略过去。这种对细节的钝感有时会导致理解偏差甚至造成实际损失。",
                  "social": "在社交互动中，你对他人细微的情绪变化、语气转折和肢体语言不够敏感。别人可能已经明显不悦或尴尬了，而你还浑然不觉地继续。这种观察力的欠缺会让你在无意中伤害他人感情或错过重要社交信号。"
            },
            "1": {
                  "study": "你的观察能力处于正常偏低水平。你能察觉比较明显的差异和变化，但细微的线索——文字中个别字的差异、画面中微小的异常——有时会漏掉。在快速浏览或时间压力下尤其容易错过细节。建议培养慢下来的观察习惯。",
                  "work": "日常工作中你能把握大部分信息，但在审阅文件或检查结果时，偶尔会漏掉一些不显眼的错误或细微异常。你可以在完成重要任务后特地抽出时间回头再检查一遍关键细节。",
                  "social": "你大约能感知到他人明显的情绪变化，但对于微妙的社交信号——一闪而过的眼神、语调的微小转变——有时会错过。多观察对方的眼睛和嘴部的细微变化，能帮助你提升社交敏感度。"
            },
            "2": {
                  "study": "你的观察能力基本能够满足日常学习和工作的注意需求。你能够发现比较明显的细节和差异，在大多数常规场景下不至于因观察力不足而频繁出错。对于重要事项，你能够给予足够关注。",
                  "work": "在日常工作检查和常规质量把控方面，你的观察力基本够用。你不会频繁漏掉显而易见的错误或异常。在需要特别注意的场景中，你能够主动加强关注。",
                  "social": "你的社交观察力在正常范围内——你能注意到对方比较明显的情绪状态变化和反应。日常社交互动中不至于因完全不察言观色而频繁陷入尴尬。"
            },
            "3": {
                  "study": "你的观察能力良好。你善于在繁杂的信息中精准捕捉到关键细节，无论是一处文字差异、图像中的异常，还是他人表情的微妙变化。这种观察力让你在学习和工作中的质量都有可靠保障。",
                  "work": "在工作检查和质量把关方面，你是团队中可依赖的人。你能挑出别人容易忽略的细节错误、发现流程中的不合理之处。你的输出质量经得起仔细推敲。",
                  "social": "你的社交观察力不错。你能注意到对方的情绪变化、对新话题的反应、是否想要结束对话等微妙信号。这让你的社交互动更体贴、更有分寸感、更少踩雷。"
            },
            "4": {
                  "study": "你的观察力堪称一绝。你几乎不会错过任何细节——文字中的错别字、画面中的违和感、一个人的微表情变化——这些都逃不过你的眼睛。这种超常的观察力让你在任何需要细心和精确的领域都如鱼得水。",
                  "work": "你有着鹰眼般的敏锐洞察力。工作中你能第一时间发现数据异常、流程漏洞、质量隐患和潜在风险。你的存在本身就是一道质量防线——因为你看到的东西，其他人常常会完全漏掉。",
                  "social": "在社交中，你的观察力让你成为一个读人高手。你能从最细微的表情变化、语气波动和肢体语言中读出对方的真实情绪和隐藏想法。对方藏在心里的开心、不安、不耐烦——你都在他们还没开口前就已经看到了。"
            }
      }
};
  ...
  function _doRenderReport(rawLog, isQuick6) {
    ...
    // 云端上传已迁移: 神经系统自评走 Supabase (questionnaire.html), 认知报告仅本机保存
    history = loadHistory();
  ...
  window._showCogRecordList = function() {
    ...
    // 搜索框 (overlay 内保留, 关闭 overlay 时随闭包释放)
    var searchQuery = '';
    ...
    // 通用行构建: kind 与删除按钮按类型生成
    function _buildRecordRow(rec) {
      ...
      var rightHtml = '<button class="cog-rec-del" data-rec-id="'+_escHtml(rec.id||'')+'" title="删除本机记录" style="flex-shrink:0;margin-left:8px;background:none;border:none;font-size:16px;cursor:pointer;color:#ccc;padding:4px 8px;border-radius:4px;transition:color 0.15s;" onmouseenter="this.style.color=\'#e74c3c\'" onmouseleave="this.style.color=\'#ccc\'">🗑️</button>';
    ...
    function _bindLocalRowEvents(row, rec, patientName, wrap) {
      ...
      row.querySelector('.cog-rec-del').addEventListener('click', function(e) {
        e.stopPropagation();
        if (!confirm('确定删除 ' + patientName + ' 的这份本机报告吗？')) return;
        try {
